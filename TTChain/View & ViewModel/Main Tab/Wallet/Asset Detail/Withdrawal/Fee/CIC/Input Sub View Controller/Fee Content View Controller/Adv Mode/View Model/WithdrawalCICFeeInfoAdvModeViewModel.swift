//
//  WithdrawalCICFeeInfoAdvModeViewModel.swift
//  OfflineWallet
//
...
class WithdrawalCICFeeInfoAdvModeViewModel: KLRxViewModel, WithdrawalETFFeeInfoModeBase {
    ...
    var input: WithdrawalCICFeeInfoAdvModeViewModel.Input
    var output: Void
