//
//  WithdrawalETHFeeInfoAdvModeViewController.swift
//  OfflineWallet
//
...
final class WithdrawalETHFeeInfoAdvModeViewController: KLModuleViewController, KLVMVC {
    ...
    typealias ViewModel = WithdrawalETHFeeInfoAdvModeViewModel
    var viewModel: WithdrawalETHFeeInfoAdvModeViewModel!
    var bag: DisposeBag = DisposeBag.init()
    func config(constructor: Void) {
        view.layoutIfNeeded()
        viewModel = ViewModel.init(
            input: WithdrawalETHFeeInfoAdvModeViewModel.InputSource(
    ...
    override func renderLang(_ lang: Lang) {
        ...
        gasPriceLabel.text = dls.fee_eth_gwei
    }
