//
//  WithdrawalETHFeeInfoViewModel.swift
//  OfflineWallet
//
...
protocol WithdrawalETFFeeInfoBase: WithdrawalFeeInfoProvider {
    var totalGas: Observable<Decimal?> { get }
    var gas: Observable<Decimal?> { get }
    var gasPrice: Observable<Decimal?> { get }
}

class WithdrawalETHFeeInfoViewModel: KLRxViewModel, WithdrawalETFFeeInfoBase {
    ...
    var input: WithdrawalETHFeeInfoViewModel.Input
    var output: Void
