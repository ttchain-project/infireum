//
//  TransRecord+CoreDataProperties.swift
//  OfflineWallet
//
...
extension TransRecord {
    ...
    @nonobjc public class func fetchRequest() -> NSFetchRequest<TransRecord> {
        return NSFetchRequest<TransRecord>(entityName: "TransRecord")
    }

//    @NSManaged public var inoutID: Int16
