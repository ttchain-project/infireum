...
struct DLS_ZH_CN: DLS {
    ...
    var g_something_went_wrong = "有些不对劲。 请再试一次。"
    ...
    var tab_me = "我的"
    var tab_chat = "聊天"
    var tab_alert_newSystemWallet_title = "Infireum 支援了新的钱包！"
    ...
    var settings_notification_title:String = "讯息通知"
    var setting_export_key_title:String = "导出"
    ...
    var wallet_settings_title:String = "钱包设定"
    var account_safety_settings_title:String = "帐号安全"
    ...
    var chat_room_audio_call = "音频通话"
    var chat_room_video_call = "视频电话"
    ...
    var chat_history_delete_chat_message:String = "您确定要删除此聊天中的所有讯息吗？"
    ...
    var receipt_message_string:String = "已发送收款讯息"
    
    var download_file_title:String = "下载"
    ...
    var lightning_payment_title:String = "闪电转帐"
    ...
    var add_wallet_password_warning_one = "Infireum团队不会保存您的钱包密码，也无法在您遗失钱包密码时协助寻回，请谨慎设立密码与密码提示。"
